      ...
      <div className="lg:sticky lg:top-20 h-fit">
        <div className="card p-6 space-y-4">
          ...
          <div className="flex gap-3 pt-2">
            <Link
              href="/"
              className="inline-flex items-center justify-center px-4 py-2 rounded-xl bg-slate-900 text-white hover:bg-slate-800 transition dark:bg-sky-600 dark:text-white dark:hover:bg-sky-500"
            >
              ← Kembali
            </Link>
